import '../styles/DecadaPage.css'
const Decada = (props) => {
    return (
        <article id="fondo">
            <main className="holder">

                <aside className="revistas">
                    <i className="fa-solid fa-ghost"></i>
                    <h4>El periodismo y las revistas comienzan a cambiar, y tienen noticias exclusivas del gaming</h4>
                ...
                <aside className="datocurioso"> <i class="fa-solid fa-ghost"></i>
                    <h4>Sabias que...?</h4>
                    <h4>Nintendo en realidad se fundó inicialmente como una empresa manufacturera de cartas. Pero no hablamos
                        de
                        ...
                        Nintendo vendía cartas tradicionales en Japón y fue así como originalmente se hizo un nombre.</h4>
